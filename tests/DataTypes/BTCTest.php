...
it('should generate a valid BTC QR code', function (): void {
...
it('should generate a valid BTC QR code with message', function (): void {
...
it('should generate a valid BTC QR code with label and message', function (): void {
...
it('should generate a valid BTC QR code with label and message and return address', function (): void {
...
it('throws an exception when Bitcoin address is empty', function (): void {
    BitcoinData::create('', 0.0034);
})->throws(InvalidArgumentException::class, 'Bitcoin address cannot be empty');

it('throws an exception when Bitcoin amount is zero or negative', function (): void {
